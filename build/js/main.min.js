...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_burger__WEBPACK_IMPORTED_MODULE_2__["toggleMobileMenu"])();
...
var toggleMobileMenu = function toggleMobileMenu() {
  ...
  var navigationElement = document.querySelector('[data-navigation]');
  var togglerElement = document.querySelector('[data-toggler]');
  var logoElement = document.querySelector('[data-navigation-logo]');
  var elements = [headerElement, navigationElement, togglerElement, logoElement];
  ...
  document.addEventListener('click', function (evt) {
    var isTogglerTarget = evt.target === togglerElement;
    var isLinkTarget = evt.target.nodeName === 'A';
...
function initMap() {
  ...
  script.onload = function () {
    ...
    ymaps3.ready.then(function () {
      ...
      ymaps3.import('@yandex/ymaps3-controls@0.0.1').then(function (res) {
        var YMapZoomControl = res.YMapZoomControl;
